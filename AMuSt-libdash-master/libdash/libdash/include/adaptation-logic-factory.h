...
typedef AdaptationLogic* (*ALogicFunctionPointer)(MultimediaPlayer*);
//     / RETURN TYPE     / Function Pointer Name / Parameter 1
...
public:
  ...
  static AdaptationLogicFactory* GetInstance()
  {
      static AdaptationLogicFactory* instance = new AdaptationLogicFactory();
      return instance;
  }
...
public:
  ...
  static AdaptationLogic* Create(std::string adaptationLogicType, MultimediaPlayer* mPlayer)
  {
