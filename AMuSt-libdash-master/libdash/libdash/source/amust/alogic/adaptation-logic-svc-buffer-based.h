...
class SVCBufferBasedAdaptationLogicAggressive : AbstractSVCBufferBasedAdaptationLogic
{
  ...
  {
    return new AbstractSVCBufferBasedAdaptationLogic(mPlayer, BUFFER_ALPHA_AGGRESSIVE, BUFFER_MIN_SIZE_AGGRESSIVE);
  }
...
class SVCBufferBasedAdaptationLogicConservative : AbstractSVCBufferBasedAdaptationLogic
{
  ...
  static AdaptationLogic* Create(MultimediaPlayer* mPlayer)
  {
    return new AbstractSVCBufferBasedAdaptationLogic(mPlayer, BUFFER_ALPHA_CONSERVATIVE, BUFFER_MIN_SIZE_CONSERVATIVE);
  }
...
class SVCBufferBasedAdaptationLogicNormal : AbstractSVCBufferBasedAdaptationLogic
{
  ...
  static AdaptationLogic* Create(MultimediaPlayer* mPlayer)
  {
    return new AbstractSVCBufferBasedAdaptationLogic(mPlayer, BUFFER_ALPHA_NORMAL, BUFFER_MIN_SIZE_NORMAL);
  }
